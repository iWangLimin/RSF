...
if __name__ == '__main__':
    ...
    model = ResidualRecursiveFusion(ms_max_recurse=4,ms_conv_depth=4,ms_grow=16,\
                                    pan_max_recurse=8,pan_conv_depth=8,pan_grow=12)
    ...
    ms_loss,pan_loss,loss= model.loss(ms_fusion,pan_fusion,fusion)
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            train_loss,step_value,_=sess.run([train_summary,step,train_op],feed_dict=\
                ...
                try:
                    ...
                    if acc_value<best_acc:
                        ...
                        saver.save(sess=sess,\
                            save_path=os.path.join(os.getcwd(), './checkpoint_ARF/ARF/model'),global_step=step)
